package com.yh.dwdatalink.configuration;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.yh.dwdatalink.configuration.consts.CoreConstant;
...
/**
 * Created by zhou1 on 2019/3/9.
 */
public class Configuration {
    
    public static final int configErr = 1;
    public static final int runTimeErr = 2;
    public static final int remoteCallErr = 3;
    ...
    public static Configuration from(String json) {
        ...
        try {
            ...
            throw DataXException.asDataXException(configErr,
                    e);
        }
    ...
    public String getUnnecessaryValue(String key,String defaultValue,Integer errorCode) {
    ...
    private void setObject(final String path, final Object object) {
        ...
        throw DataXException.asDataXException(runTimeErr,
...
//
//
//        System.err.println(conf.get(CoreConstant.DATAX_JOB_CONTENT_READER_NAME));

        String conf =  ConfigUtil.getJobContent("http://127.0.0.1:8085/config/oxox");
        System.err.println(conf);
        try{
            FileUtil.writeFile("C:\\Users\\zhou1\\Downloads\\datax\\job\\job.json",conf);
        }catch (Exception e){
            e.printStackTrace();
        }
